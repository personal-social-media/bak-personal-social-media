...
describe "DELETE /client/cache_reactions/:id", vcr: :record_once do
  ...
  let(:cache_reaction) { create(:cache_reaction, subject: feed_item, remote_id: 2) }
  ...
  it "deletes the cache reaction" do
    cache_reaction
