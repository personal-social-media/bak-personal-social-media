export default function LikeReaction({cacheReaction, imageOptions = {}, containerOptions = {}}) {
  ...
  return (
    <div {...containerOptions} aria-label="Like">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" {...mergedItemOptions}>
